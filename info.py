...
# Bot information
SESSION = environ.get('SESSION', 'FWMovie_bot')
API_ID = int(environ.get('API_ID', '27963025'))
API_HASH = environ.get('API_HASH', 'd8e4edf2a05087baafb36b1d66e30271')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/INL.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '848067423').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002602890739'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002654832934').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002654832934')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jatr14151:M4jhDPOMUkxNzJML@cluster0.9domc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "fwmovieclonefilterbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'fwcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MovieRequest_Group2025')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/FILMYBOY_BACKUP')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/FwSupportGroup') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@Rohit_Jaat')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'e72a0610e358441ca9747355e6f95288c52c7b10')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/dglinkopen/53') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
